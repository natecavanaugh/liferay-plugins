<div class="columns-1-3-2" id="main-content" role="main">
		...
		<tr>
			<td class="aui-w66 portlet-column portlet-column-first">
				<table class="portlet-layout">
				<tr>
					<td class="aui-w100 portlet-column portlet-column-first" id="column-5">
				...
				<tr>
					...
					<td class="aui-w50 portlet-column" id="column-7">
		...
		<div class="portlet-layout">
			<div class="aui-w66 portlet-column portlet-column-first">
				...
				<div class="portlet-layout">
					<div class="aui-w50 portlet-column portlet-column-first" id="column-6">
						$processor.processColumn("column-6", "portlet-column-content portlet-column-content-first")
					</div>

					<div class="aui-w50 portlet-column" id="column-7">
